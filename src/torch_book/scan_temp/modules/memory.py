...
def dmas_relu(module: nn.ReLU | nn.ReLU6, inp: Tensor, out: Tensor) -> int:
...
def dmas_act_single_param(module: nn.ELU | nn.LeakyReLU, inp: Tensor, out: Tensor) -> int:
...
def dmas_pool(module: _MaxPoolNd | _AvgPoolNd, inp: Tensor, out: Tensor) -> int:
...
def dmas_adaptive_pool(module: _AdaptiveMaxPoolNd | _AdaptiveAvgPoolNd, inp: Tensor, out: Tensor) -> int:
