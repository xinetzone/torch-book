...
def use_svg_display(): # TODO
    """Use the svg format to display a plot in Jupyter.

    Defined in :numref:`sec_calculus`"""
    backend_inline.set_matplotlib_formats('svg')

def set_figsize(figsize=(3.5, 2.5)): # TODO
...
def set_axes(axes, xlabel, ylabel, xlim, ylim, xscale, yscale, legend): # TODO
...
def plot(X, Y=None, xlabel=None, ylabel=None, legend=[], xlim=None,
         ...
         fmts=('-', 'm--', 'g-.', 'r:'), figsize=(3.5, 2.5), axes=None): # TODO
    """Plot data points.
...
def evaluate_accuracy_gpu(net, data_iter, device=None): # TODO
...
def train_ch6(net, train_iter, test_iter, num_epochs, lr, device): # TODO
